...
Pass HTTP (port 80) requests to the backend application (port 8000)
Pass HTTPS requests (port 443) to the backend application (port 8000) (OPTIONAL)
In case HTTPS is implemented, redirect port 80 requests to 443. Special points how you manage tls cert generation,
